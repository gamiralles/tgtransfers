const post = [
  {
    ...
    info3b:
      "Minitrekking por el Glaciar. Camina sobre el hielo experimentando la fuerza y el poder de la Naturaleza.",
    info3c:
      "Navegación por Todos los Glaciares. Disfruta de un paseo en barco por el Lago Argentino, observa de cerca los glaciares Perito Moreno, Upsala, Spegazzini y otros, disfrutando de las vistas panorámicas de la Patagonia.",
    info3d:
  ...
  },
  {
    ...
    info2b:
      "El pueblo también ofrece una variedad de otras actividades, como caminatas, pesca, kayak y rafting.",
    info2c:
      "El mejor momento para visitar El Chalten es durante los meses de verano, cuando las temperaturas son más altas y el clima es mas estable.",
    titulo3: "Que Hacer?",
    info3a:
      "A 12,5 kilómetros de El Chalten, se encuentra la Laguna de los Tres, uno de los trekkings más populares de la Patagonia. Con una dificultad media, el sendero ofrece vistas privilegiadas del imponente Cerro Fitz Roy, una de las cumbres más emblemáticas de la región.",
    info3b:
      "A 9,5 kilómetros de El Chalten, se encuentra la Laguna Torre, otro de los trekkings más populares de la región. Con una dificultad media, el sendero ofrece vistas de la base del Cerro Torre, una de las montañas más desafiantes del mundo.",
    info3c:
      "A 4 kilómetros de El Chalten, se encuentra la Laguna Capri, un tranquilo lugar ideal para relajarse y disfrutar de la naturaleza. Con una dificultad baja, el sendero ofrece la vista de una laguna de aguas azules rodeada de bosque nativo.",
    info3d:
      "A 3,5 kilómetros de El Chalten, se encuentra el Chorrillo del Salto, una hermosa cascada de deshielo. Con una dificultad baja, el sendero ofrece vistas de la cascada y el bosque nativo.",
    info3e:
      "A 37 kilómetros de El Chalten, se encuentra el Lago del Desierto, un imponente espejo de agua cristalina rodeado de un paisaje natural de cerros, montañas y bosque",
    titulo4: "Nuestro Servicio",
  ...
  },
  {
    ...
    info3b:
      "Capillas de Mármol, visita una de las maravillas naturales más icónicas de la Patagonia, conoce sus formaciones rocosas de mármol esculpidas por el agua y el viento durante millones de años. Una navegación perfecta para los amantes de la naturaleza y la fotografía.",
    info3c:
      "Cabalgata por el Cerro Castillo, recorre los senderos del PN, experimenta la Patagonia de una manera única, con vistas panorámicas de los picos nevados y los bosques nativos.",
    info3d:
